...
public class Cyclotron extends SimulatorInstanceSwing {
	...
	private SimVariableBean velocityBean = new SimVariableBean();
	...
	public void animationLogic() {
			...
			while(part1 == true){
				...
				timeBeanLocal.setTime(timeBeanLocal.getTime() / (1000/sMult));
				if(reset1==true){
					timeBeanLocal.setTime(timeBeanLocal.getTime() / (1000/sMult));
					radius=r2cy-y;
				}
			...
			while(part4 == true){
				...
				velocityBean.setValue((int)((2*Math.PI*radius)/6));
	...
	public void LoadData() {
		...
		data_shared_read = new Object[][] { {"Particle Velocity", velocityBean.getSimVariableBeanProperty()}};
